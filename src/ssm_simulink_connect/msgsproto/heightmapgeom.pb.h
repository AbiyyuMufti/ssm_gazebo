...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_heightmapgeom_2eproto 
...
extern HeightmapGeomDefaultTypeInternal _HeightmapGeom_default_instance_;
class HeightmapGeom_Blend;
class HeightmapGeom_BlendDefaultTypeInternal;
extern HeightmapGeom_BlendDefaultTypeInternal _HeightmapGeom_Blend_default_instance_;
class HeightmapGeom_Texture;
class HeightmapGeom_TextureDefaultTypeInternal;
extern HeightmapGeom_TextureDefaultTypeInternal _HeightmapGeom_Texture_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::HeightmapGeom* Arena::CreateMaybeMessage<::gazebo::msgs::HeightmapGeom>(Arena*);
template<> ::gazebo::msgs::HeightmapGeom_Blend* Arena::CreateMaybeMessage<::gazebo::msgs::HeightmapGeom_Blend>(Arena*);
template<> ::gazebo::msgs::HeightmapGeom_Texture* Arena::CreateMaybeMessage<::gazebo::msgs::HeightmapGeom_Texture>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class HeightmapGeom_Texture : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.HeightmapGeom.Texture) */ {
 public:
...
class HeightmapGeom_Blend : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.HeightmapGeom.Blend) */ {
 public:
  HeightmapGeom_Blend();
...
class HeightmapGeom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.HeightmapGeom) */ {
 public:
  HeightmapGeom();
