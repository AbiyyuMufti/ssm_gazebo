...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Image* Arena::CreateMaybeMessage<::gazebo::msgs::Image>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Image : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Image) */ {
 public:
  Image();
  virtual ~Image();
