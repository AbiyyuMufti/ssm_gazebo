...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_sensor_5fnoise_2eproto 
...
extern SensorNoiseDefaultTypeInternal _SensorNoise_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::SensorNoise* Arena::CreateMaybeMessage<::gazebo::msgs::SensorNoise>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class SensorNoise : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.SensorNoise) */ {
 public:
  SensorNoise();
  virtual ~SensorNoise();
