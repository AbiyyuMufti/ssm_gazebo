...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_polylinegeom_2eproto 
...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Polyline* Arena::CreateMaybeMessage<::gazebo::msgs::Polyline>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Polyline : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Polyline) */ {
 public:
  Polyline();
  virtual ~Polyline();
