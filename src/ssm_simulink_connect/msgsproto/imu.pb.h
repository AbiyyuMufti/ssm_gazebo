...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::IMU* Arena::CreateMaybeMessage<::gazebo::msgs::IMU>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class IMU : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.IMU) */ {
 public:
  IMU();
  virtual ~IMU();
