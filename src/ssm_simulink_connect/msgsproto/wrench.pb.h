...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Wrench* Arena::CreateMaybeMessage<::gazebo::msgs::Wrench>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Wrench : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Wrench) */ {
 public:
  Wrench();
  virtual ~Wrench();
