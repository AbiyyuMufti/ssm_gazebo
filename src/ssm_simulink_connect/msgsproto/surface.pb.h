...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_surface_2eproto 
...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Surface* Arena::CreateMaybeMessage<::gazebo::msgs::Surface>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Surface : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Surface) */ {
 public:
  Surface();
  virtual ~Surface();
