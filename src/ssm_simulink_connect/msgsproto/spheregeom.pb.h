...
#ifndef PROTOBUF_INCLUDED_spheregeom_2eproto
#define PROTOBUF_INCLUDED_spheregeom_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_spheregeom_2eproto 
...
extern SphereGeomDefaultTypeInternal _SphereGeom_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::SphereGeom* Arena::CreateMaybeMessage<::gazebo::msgs::SphereGeom>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class SphereGeom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.SphereGeom) */ {
 public:
  SphereGeom();
  virtual ~SphereGeom();
  ...
  inline SphereGeom* New() const final {
    return CreateMaybeMessage<SphereGeom>(NULL);
  }

  SphereGeom* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  double radius_;
  friend struct ::protobuf_spheregeom_2eproto::TableStruct;
};
// ===================================================================
...
#endif  // PROTOBUF_INCLUDED_spheregeom_2eproto
