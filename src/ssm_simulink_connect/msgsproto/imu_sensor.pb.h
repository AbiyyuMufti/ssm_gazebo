...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_imu_5fsensor_2eproto 
...
extern IMUSensor_AngularVelocityDefaultTypeInternal _IMUSensor_AngularVelocity_default_instance_;
class IMUSensor_LinearAcceleration;
class IMUSensor_LinearAccelerationDefaultTypeInternal;
extern IMUSensor_LinearAccelerationDefaultTypeInternal _IMUSensor_LinearAcceleration_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::IMUSensor* Arena::CreateMaybeMessage<::gazebo::msgs::IMUSensor>(Arena*);
template<> ::gazebo::msgs::IMUSensor_AngularVelocity* Arena::CreateMaybeMessage<::gazebo::msgs::IMUSensor_AngularVelocity>(Arena*);
template<> ::gazebo::msgs::IMUSensor_LinearAcceleration* Arena::CreateMaybeMessage<::gazebo::msgs::IMUSensor_LinearAcceleration>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class IMUSensor_AngularVelocity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.IMUSensor.AngularVelocity) */ {
 public:
...
class IMUSensor_LinearAcceleration : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.IMUSensor.LinearAcceleration) */ {
 public:
...
class IMUSensor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.IMUSensor) */ {
 public:
  IMUSensor();
  virtual ~IMUSensor();
