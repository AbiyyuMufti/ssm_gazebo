...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_int_2eproto 
...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Int* Arena::CreateMaybeMessage<::gazebo::msgs::Int>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Int : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Int) */ {
 public:
  Int();
  virtual ~Int();
