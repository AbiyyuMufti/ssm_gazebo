...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_collision_2eproto 
...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Collision* Arena::CreateMaybeMessage<::gazebo::msgs::Collision>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Collision : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Collision) */ {
 public:
  Collision();
  virtual ~Collision();
