...
::google::protobuf::internal::SCCInfo<0> scc_info_ImageGeom =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsImageGeom}, {}};
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, uri_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, scale_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, threshold_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, height_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gazebo::msgs::ImageGeom, granularity_),
  0,
  1,
  4,
  2,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::gazebo::msgs::_ImageGeom_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "imagegeom.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::Descriptor* ImageGeom::descriptor() {
  ::protobuf_imagegeom_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_imagegeom_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ImageGeom& ImageGeom::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_imagegeom_2eproto::scc_info_ImageGeom.base);
...
::google::protobuf::Metadata ImageGeom::GetMetadata() const {
  protobuf_imagegeom_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_imagegeom_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::gazebo::msgs::ImageGeom* Arena::CreateMaybeMessage< ::gazebo::msgs::ImageGeom >(Arena* arena) {
