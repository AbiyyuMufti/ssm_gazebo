...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_planegeom_2eproto 
...
extern PlaneGeomDefaultTypeInternal _PlaneGeom_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::PlaneGeom* Arena::CreateMaybeMessage<::gazebo::msgs::PlaneGeom>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class PlaneGeom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.PlaneGeom) */ {
 public:
  PlaneGeom();
  virtual ~PlaneGeom();
