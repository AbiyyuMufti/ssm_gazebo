...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Geometry* Arena::CreateMaybeMessage<::gazebo::msgs::Geometry>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Geometry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Geometry) */ {
 public:
  Geometry();
  virtual ~Geometry();
