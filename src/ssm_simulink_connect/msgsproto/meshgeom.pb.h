...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_meshgeom_2eproto 
...
extern MeshGeomDefaultTypeInternal _MeshGeom_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::MeshGeom* Arena::CreateMaybeMessage<::gazebo::msgs::MeshGeom>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class MeshGeom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.MeshGeom) */ {
 public:
  MeshGeom();
  virtual ~MeshGeom();
