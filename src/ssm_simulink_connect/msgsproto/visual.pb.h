...
#ifndef PROTOBUF_INCLUDED_visual_2eproto
#define PROTOBUF_INCLUDED_visual_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_visual_2eproto 
...
extern Visual_MetaDefaultTypeInternal _Visual_Meta_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Visual* Arena::CreateMaybeMessage<::gazebo::msgs::Visual>(Arena*);
template<> ::gazebo::msgs::Visual_Meta* Arena::CreateMaybeMessage<::gazebo::msgs::Visual_Meta>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Visual_Meta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Visual.Meta) */ {
 public:
  Visual_Meta();
  virtual ~Visual_Meta();
 ...
 private:
  ...
  friend struct ::protobuf_visual_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Visual : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Visual) */ {
 public:
  Visual();
  virtual ~Visual();
 ...
 private:
  ...
  void set_has_delete_me();
  void clear_has_delete_me();
...
inline const ::gazebo::msgs::Visual_Meta& Visual::meta() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::gazebo::msgs::Visual_Meta*>(
...
#endif  // PROTOBUF_INCLUDED_visual_2eproto
