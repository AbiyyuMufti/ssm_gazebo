...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_boxgeom_2eproto 
...
extern BoxGeomDefaultTypeInternal _BoxGeom_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::BoxGeom* Arena::CreateMaybeMessage<::gazebo::msgs::BoxGeom>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class BoxGeom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.BoxGeom) */ {
 public:
  BoxGeom();
  virtual ~BoxGeom();
