...
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Plugin* Arena::CreateMaybeMessage<::gazebo::msgs::Plugin>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Plugin : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Plugin) */ {
 public:
  Plugin();
  virtual ~Plugin();
