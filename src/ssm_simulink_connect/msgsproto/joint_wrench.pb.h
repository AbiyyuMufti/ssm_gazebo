...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_joint_5fwrench_2eproto 
...
extern JointWrenchDefaultTypeInternal _JointWrench_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::JointWrench* Arena::CreateMaybeMessage<::gazebo::msgs::JointWrench>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class JointWrench : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.JointWrench) */ {
 public:
  JointWrench();
  virtual ~JointWrench();
