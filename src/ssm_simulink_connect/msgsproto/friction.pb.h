...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_friction_2eproto 
...
extern FrictionDefaultTypeInternal _Friction_default_instance_;
class Friction_Torsional;
class Friction_TorsionalDefaultTypeInternal;
extern Friction_TorsionalDefaultTypeInternal _Friction_Torsional_default_instance_;
class Friction_Torsional_ODE;
class Friction_Torsional_ODEDefaultTypeInternal;
extern Friction_Torsional_ODEDefaultTypeInternal _Friction_Torsional_ODE_default_instance_;
}  // namespace msgs
}  // namespace gazebo
namespace google {
namespace protobuf {
template<> ::gazebo::msgs::Friction* Arena::CreateMaybeMessage<::gazebo::msgs::Friction>(Arena*);
template<> ::gazebo::msgs::Friction_Torsional* Arena::CreateMaybeMessage<::gazebo::msgs::Friction_Torsional>(Arena*);
template<> ::gazebo::msgs::Friction_Torsional_ODE* Arena::CreateMaybeMessage<::gazebo::msgs::Friction_Torsional_ODE>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gazebo {
namespace msgs {
...
class Friction_Torsional_ODE : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Friction.Torsional.ODE) */ {
 public:
...
class Friction_Torsional : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Friction.Torsional) */ {
 public:
  Friction_Torsional();
...
class Friction : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.Friction) */ {
 public:
  Friction();
  virtual ~Friction();
