...
cl_table(1,:) = [0.000, 1.017, 2.067, 3.218, 4.176, 5.066, 5.836, 6.576];
cd_table(1,:) = [0.266, .321, .487, .835, 1.337, 2.014, 2.738, 3.553];
...
cl_table(2,:) = [0.000, 1.031, 2.087, 3.233, 4.167, 5.066, 5.889, 6.716];
cd_table(2,:) = [0.263, .318, .488, .838, 1.333, 2.011, 2.754, 3.613];
...
cl_table(4,:) = [0.000, 1.074, 2.161, 3.341, 4.287, 5.219, 6.179, 7.240];
cd_table(4,:) = [0.259, .316, .488, .848, 1.355, 2.056, 2.869, 3.862];
...
cl_table(5,:) = [0.000, 1.081, 2.172, 3.353, 4.323, 5.341, 6.381, 7.568];
cd_table(5,:) = [0.257, .314, .487, .848, 1.363, 2.097, 2.951, 4.021];
...
cl_table(6,:) = [0.000, 1.099, 2.204, 3.399, 4.397, 5.452, 6.543, 7.790];
cd_table(6,:) = [0.256, .314, .489, .855, 1.382, 2.135, 3.020, 4.132];
...
cl_table(7,:) = [0.000, 1.128, 2.275, 3.547, 4.628, 5.753, 6.915, 8.201];
cd_table(7,:) = [0.271, .330, .510, .894, 1.455, 2.255, 3.196, 4.359];
...
cl_table(8,:) = [0.000, 1.219, 2.454, 3.848, 5.074, 6.360, 7.694, 9.278];
cd_table(8,:) = [0.458, .541, .790, 1.248, 1.870, 2.709, 3.748, 5.100];
